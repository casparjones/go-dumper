  ...
  <div class="mx-auto max-w-3xl space-y-6">
    ...
    <div class="card bg-base-100 border border-base-200 shadow-sm">
      <div class="card-body gap-4">
        <h3 class="card-title">Select Configuration</h3>
        ...
        <div class="grid gap-4 md:grid-cols-2">
          <div class="form-control">
            ...
            <label v-if="!selectedConfig" class="label">
              <span class="label-text-alt">Choose a configuration to view details</span>
            </label>
          </div>
          ...
          <div class="form-control">
            ...
            <div class="space-y-3 flex flex-col">
              <label class="label cursor-pointer flex-row items-start gap-1">
                <input type="checkbox" v-model="compressBackup" class="toggle toggle-primary" />
                <span class="label-text">Compress backup</span>
              </label>

              <label class="label cursor-pointer flex-row items-start gap-1 opacity-60">
        ...
        <div class="grid gap-4 md:grid-cols-3">
          <div>
            ...
            <div class="font-medium">
              {{ selectedTargetInfo.host }}:{{ selectedTargetInfo.port }}
            </div>
          </div>
          <div>
      ...
      <div class="card-body gap-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
          <button
              ...
              :title="!selectedConfig ? 'Please select a configuration first' : ''"
          >
          ...
          <span v-if="!selectedConfig" class="text-sm text-base-content/50">
